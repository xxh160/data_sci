...
if(__name__ == "__main__"):
    pretreatment("./server/app/scraper/store/weibo/", "./server/app/pretreatment/store/weibo/",
    ...
    pretreatment("./server/app/scraper/store/bilibili/", "./server/app/pretreatment/store/bilibili/",
                 datetime.date(2020, 2, 9), datetime.date(2020, 3, 9))
    pretreatment("./server/app/scraper/store/bilibili/", "./server/app/pretreatment/store/bilibili/",
                 datetime.date(2020, 3, 10), datetime.date(2020, 6, 15))
    pretreatment("./server/app/scraper/store/bilibili/", "./server/app/pretreatment/store/bilibili/",
                 datetime.date(2020, 6, 16), datetime.date(2020, 9, 30))
    pretreatment("./server/app/scraper/store/bilibili/", "./server/app/pretreatment/store/bilibili/",
                 datetime.date(2020, 10, 1), datetime.date(2021, 1, 20))
    pretreatment("./server/app/scraper/store/south/", "./server/app/pretreatment/store/south/",
